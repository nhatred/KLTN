    ...
    const calculateTimeRemaining = () => {
        ...
        if (difference <= 0) {
            ...
            if (endTimeDifference <= 0) {
                ...
                setEndTimeRemaining(`${hours}:${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}`);
            }
            return;
        }
                        ...
                        <div className="flex absolute items-center justify-center rounded-lg gap-2">
                            {room?.status === 'active' ? (
                                <div className="text-darkblue rounded-lg bg-orange px-10 py-5 animate-pulse-scale">
                                    <p className="text-xl font-semibold">Kết thúc sau {endTimeRemaining}</p>
                                </div>
                            ) : (
