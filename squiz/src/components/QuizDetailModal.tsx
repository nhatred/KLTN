      ...
      >
        <div className="relative quizcard_component">
          ...
          <div className="absolute top-4 right-4">
            <p className={`py-1 px-4 text-sm text-background font-semibold rounded-full ${
        ...
        <div className="p-6">
          <div className="flex justify-between items-start flex-wrap gap-4 mb-6">
            ...
            <div className="flex items-center gap-2 bg-gray-100 px-3 py-1.5 rounded-full">
              ...
              <p className="font-semibold">{quiz?.questions?.length || 0} câu hỏi</p>
            </div>
            ...
            <div className="flex items-center gap-2 bg-gray-100 px-3 py-1.5 rounded-full">
             <HugeiconsIcon icon={UserGroup03Icon} size={18} color="#3366FF" />
                          <p className="font-semibold">{formatPlayCount(quiz?.totalPlays || 0)} lượt chơi</p>
            </div>
            </div>
